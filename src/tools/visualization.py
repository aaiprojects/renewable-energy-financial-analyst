...
class ChartGenerator:
    ...
    def create_price_chart(self, tickers: List[str], timeframe: str = "30d", 
        ...
        if not PLOTLY_AVAILABLE:
            return self._create_no_plotly_message()
    ...
    def create_sector_overview(self, subsector: Optional[str] = None):
    ...
    def create_technical_analysis_chart(self, ticker: str, timeframe: str = "30d"):
    ...
    def _create_returns_comparison(self, tickers: List[str], days: int):
    ...
    def _create_volatility_comparison(self, tickers: List[str], days: int):
    ...
    def _create_no_plotly_message(self):
        """Create a message when plotly is not available."""
        return {
            "error": "Plotly not available",
            "message": "Install plotly with: pip install plotly>=5.17.0"
        }